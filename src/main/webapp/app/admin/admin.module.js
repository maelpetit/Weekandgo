...
var _1 = require("./");
var WeekandgoAdminModule = /** @class */ (function () {
    function WeekandgoAdminModule() {
    }
    WeekandgoAdminModule = __decorate([
        core_1.NgModule({
            imports: [
    ...
    return WeekandgoAdminModule;
}());
exports.WeekandgoAdminModule = WeekandgoAdminModule;
