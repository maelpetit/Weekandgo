...
var WeekandgoAppModule = /** @class */ (function () {
    function WeekandgoAppModule() {
    }
    WeekandgoAppModule = __decorate([
        core_1.NgModule({
            imports: [
                ...
                home_module_1.WeekandgoHomeModule,
                admin_module_1.WeekandgoAdminModule,
                account_module_1.WeekandgoAccountModule,
                entity_module_1.WeekandgoEntityModule,
            ],
            declarations: [
    ...
    return WeekandgoAppModule;
}());
exports.WeekandgoAppModule = WeekandgoAppModule;
