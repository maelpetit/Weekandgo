...
var WeekandgoSharedLibsModule = /** @class */ (function () {
    function WeekandgoSharedLibsModule() {
    }
    WeekandgoSharedLibsModule = __decorate([
        core_1.NgModule({
            imports: [
    ...
    return WeekandgoSharedLibsModule;
}());
exports.WeekandgoSharedLibsModule = WeekandgoSharedLibsModule;
