...
var _1 = require("./");
var WeekandgoAccountModule = /** @class */ (function () {
    function WeekandgoAccountModule() {
    }
    WeekandgoAccountModule = __decorate([
        core_1.NgModule({
            imports: [
    ...
    return WeekandgoAccountModule;
}());
exports.WeekandgoAccountModule = WeekandgoAccountModule;
